...
public class MainDialog extends JFrame implements ErrorHandler, DataHandler, EventHandler
{
    ...
    static 
    {
        ...
        try 
        {
            ...
            libpath = System.getProperty("user.dir")+"\\libs\\lib;"+System.getProperty("user.dir")+"\\libs;" + libpath;
    ...
    public  void start()
    {
        ...
        catch (Throwable ex)
        {
            ...
            try 
            {
                ...
                writer.write("Throws Error Detail: "+ exceptionAsString);
